var ExpApp = /** @class */ (function () {
    ...
    ExpApp.prototype.renderTasks = function () {
        ...
        this.ExpTasks.forEach(function (expTask) {
            ...
            var taskText = expTask.completed ? "<span>".concat(expTask.task, "</span>") : expTask.task;
            var listItem = document.createElement("li");
            listItem.className = taskClass;
            listItem.innerHTML = "\n                ".concat(taskText, "  ").concat(expTask.amount, "  ").concat(expTask.category, "  ").concat(expTask.date, "\n                <button onclick=\"expApp.markCompleted(").concat(expTask.id, ")\" id=\"btn\">Done</button>\n                <button onclick=\"expApp.removeTask(").concat(expTask.id, ")\" id=\"btn\">Delete</button>\n            ");
